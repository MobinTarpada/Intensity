...
namespace VideoControl
{
    ...
    [ToolboxData("<{0}:VideoPlayerControl runat=server></{0}:VideoPlayerControl>")]
    public class VideoPlayerControl : WebControl
    {
        //[Bindable(true)]
        //[Category("Appearance")]
        //[DefaultValue("")]
        ...
        protected override void RenderContents(HtmlTextWriter writer)
        {
            try
            {
                ...
                sb.Append("codebase=http://activex.microsoft.com/activex/controls/mplayer/en/nsmp2inf.cab#Version=5,1,52,701 Width = " + Width.Value.ToString() + " Height = "
                    + Height.Value.ToString() + "type=application/x-oleobject align=absmiddle");
