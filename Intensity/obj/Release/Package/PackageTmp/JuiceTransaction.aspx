<%@ Page Title="" Language="C#" MasterPageFile="~/MstFitnessCenter.Master" AutoEventWireup="true" CodeBehind="JuiceTransaction.aspx.cs" Inherits="FitnessCenter.JuiceTransaction" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        function pageLoad() {
            SetMenuActive("liJuiceTransaction");
        }
    </script>
</asp:Content>
    ...
    <asp:UpdatePanel ID="updtPnlJuice" runat="server">
        <ContentTemplate>
            <div class="page-content">
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="page-title">Juice Item Sales</h3>
                        <ul class="page-breadcrumb breadcrumb">
                            <li>
                                <i class="fa fa-home"></i>
                                <a href="JuiceTransaction.aspx">Home</a>
                ...
                <asp:Panel ID="pnlEdit" runat="server">
                    <div class="portlet box blue">
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="form-body">
                                <div class="form-group">
                                    <asp:Label ID="lblAvailable" runat="server" Text="" CssClass="fntWeightBold"></asp:Label>
                                </div>
                            </div>
                        </div>
                    </div>
