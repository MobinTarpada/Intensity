<%@ Page Title="" Language="C#" MasterPageFile="~/MstFitnessCenter.Master" AutoEventWireup="true" CodeBehind="frmManageLead.aspx.cs" Inherits="FitnessCenter.frmManageLead" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function BeginRequestHandler(sender, args) {
            if ($get('<%=updtpnl1.ClientID%>') != null) {
                x = $get('<%= updtpnl1.ClientID%>').scrollLeft;
                y = $get('<%= updtpnl1.ClientID%>').scrollTop;
            }
        }
        function EndRequestHandler(sender, args) {
            if ($get('<%= updtpnl1.ClientID%>') != null) {
                x = $get('<%= updtpnl1.ClientID%>').scrollLeft = x;
                x = $get('<%=updtpnl1.ClientID%>').scrollTop = y; 
            }
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:UpdatePanel ID="updtPnlManageLead" runat="server">
        <ContentTemplate>
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="table-responsive">
                                <asp:GridView ID="grdLead" runat="server" GridLines="None" CssClass="table table-bordered table-advance table-hover"
                                    ...
                                    OnPageIndexChanging="grdLead_PageIndexChanging" AllowPaging="true" PageSize="10" PagerStyle-CssClass="CustomPagination"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="LEAD TYPE">
                                            <ItemTemplate>
                                                <span><%# Eval("LeadTypeMaster.leadType") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                                ...
                                                <div class="portlet-body">
                                                    ...
                                                    <div class="table-responsive">
                                                        <asp:GridView ID="grdLeadFollowup" runat="server" GridLines="None" CssClass="table table-bordered table-advance table-hover"
                                                            EmptyDataText="No Record Found..!" AutoGenerateColumns="false"
                                                            OnRowCommand="grdLeadFollowup_RowCommand">
                                                            <Columns>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-body">
                                                                <div class="form-group">
                                                                    ...
                                                                    <asp:TextBox ID="txtFollowupDate" runat="server" placeholder="Followup Date.." CssClass="form-control pnlBtext-input datetime" onchange="RemoveValidate(this);"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
