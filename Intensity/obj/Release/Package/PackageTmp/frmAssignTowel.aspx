<%@ Page Title="" Language="C#" MasterPageFile="~/MstFitnessCenter.Master" AutoEventWireup="true" CodeBehind="frmAssignTowel.aspx.cs" Inherits="FitnessCenter.frmAssignTowel" %>
    ...
    <asp:UpdatePanel ID="updtPnlAssign" runat="server">
        <ContentTemplate>
            <div class="page-content">
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="page-title">Assign Towel Packages</h3>
                        <ul class="page-breadcrumb breadcrumb">
                            <li>
                                <i class="fa fa-home"></i>
                                <a href="frmAssignTowel.aspx">Home</a>
                ...
                <asp:Panel ID="pnlView" runat="server">
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <label>Assigned Towel Packages</label>
                            </div>
                        </div>
                            ...
                            <div class="table-responsive">
                                <asp:GridView ID="grdAssignedPackages" runat="server" GridLines="None" CssClass="table table-bordered table-advance table-hover"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Hiring Time Remaining">
                                            <ItemTemplate>
                                                <span><%#Eval("hiringTimeUpdate") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <div class="gridActionsIcon">
                                                    <asp:LinkButton ID="lnkBtnEdit" runat="server" ToolTip="Edit" CommandArgument='<%# Eval("ID") %>' CommandName="EditTowelMember"><i class="fa fa-edit"></i></asp:LinkButton>
                                                    <asp:LinkButton ID="lnkBtnDetail" runat="server" ToolTip="Detail" CommandArgument='<%# Eval("ID") %>' CommandName="DetailTowelMember"><i class="fa fa-file"></i></asp:LinkButton>
                                                    ...
                                                    <asp:Button ID="btnDelete" runat="server" CommandArgument='<%# Eval("ID") %>' CssClass="dsplNone" CommandName="DeleteTowelMember" />
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-body">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="drpTowelPackages" runat="server" CssClass="form-control" OnSelectedIndexChanged="drpTowelPackages_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="form-body">
                                        <div class="form-group">
                                    ...
                                    <div class="form-body">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtHiringTime" runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-body">
                                        <div class="form-group">
                                ...
                                <asp:Panel runat="server" ID="pnlAssignValues">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-body">
                                            <div class="form-group">
                                                <label class="fntWeightBold">Hiring Time Remaining</label>
                                                <asp:TextBox ID="txtHireRem" runat="server" placeholder="SessionRemaining..." CssClass="form-control" onchange="RemoveValidate(this);" ReadOnly="True"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="form-body">
                                            <div class="form-group">
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="table-responsive">
                                <asp:GridView ID="grdTrans" runat="server" GridLines="None" CssClass="table table-bordered table-advance table-hover"
                                    EmptyDataText="No Record Found..!" AutoGenerateColumns="False"
                                    AllowPaging="True" PagerStyle-CssClass="CustomPagination"
                                    AllowSorting="True" OnRowCommand="grdTrans_RowCommand">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Member Name">
                                            <ItemTemplate>
                                                <span><%# Convert.ToString(Eval("Membership.Lead.firstName")) + " " + Convert.ToString(Eval("Membership.Lead.lastName"))%></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Package Name">
                                            <ItemTemplate>
                                                <span><%#Eval("TowelHiringMaster.TowelHiringPackage.packageName") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Towel Given">
                                            <ItemTemplate>
                                                <span><%#Eval("isTowelGiven") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Towel Return">
                                            <ItemTemplate>
                                                <span><%#Eval("isTowelReturn") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Actions">
                                            <ItemTemplate>
                                                <div class="gridActionsIcon">
                                                    <asp:LinkButton ID="lnkBtnEdit" runat="server" ToolTip="Return Towel" CommandArgument='<%# Eval("ID") %>' CommandName="EditTowelTrans"><i class="fa fa-edit"></i></asp:LinkButton>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                ...
                                <div class="col-md-12">
                                    <div class="form-body">
                                        <div class="form-group">
                                            ...
                                            <asp:RadioButtonList ID="rblPayMode" runat="server" AutoPostBack="True"></asp:RadioButtonList>
                                        </div>
                                    </div>
                                    <div class="form-body">
                                        <div class="form-group">
