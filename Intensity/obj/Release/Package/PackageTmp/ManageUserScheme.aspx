                        ...
                        <div class="portlet-body">
                            ...
                            <div class="table-responsive">
                                <asp:GridView ID="grdUserScheme" runat="server" GridLines="None" CssClass="table table-bordered table-advance table-hover"
                                    ...
                                    OnRowCommand="grdUserScheme_RowCommand">
                                    <Columns>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox ID="txtAdditionalExpense" runat="server" placeholder="Additional Expense.." CssClass="form-control pnl1text-input" onchange="RemoveValidate(this);"></asp:TextBox>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox ID="txtStrTime" runat="server" placeholder="Start Time.." CssClass="form-control pnl1text-input onlyTime" onchange="RemoveValidate(this);"></asp:TextBox>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox ID="txtEndTime" runat="server" placeholder="End Time.." CssClass="form-control pnl1text-input onlyTime" onchange="RemoveValidate(this);"></asp:TextBox>
                                            </div>
                                            <div class="form-group">
