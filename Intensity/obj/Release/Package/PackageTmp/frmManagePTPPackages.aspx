<%@ Page Title="" Language="C#" MasterPageFile="~/MstFitnessCenter.Master" AutoEventWireup="true" CodeBehind="frmManagePTPPackages.aspx.cs" Inherits="FitnessCenter.frmManagePTPPackages" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        function pageLoad() {
            SetMenuActive("liManagePTPPackages");
        }
    </script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:UpdatePanel ID="updtPnlPTP" runat="server">
        <ContentTemplate>
            <div class="page-content">
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="page-title">Manage PTP Packages</h3>
                        <ul class="page-breadcrumb breadcrumb">
                            <li>
                                <i class="fa fa-home"></i>
                                <a href="frmManagePTPPackages.aspx">Home</a>
                                ...
                                <div class="col-md-6">
                                    <div class="form-body">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtPackageName" CssClass="form-control pnl1text-input" onchange="RemoveValidate(this);" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-body">
                                        <div class="form-group">
                                            <label class="fntWeightBold">Fees</label>
                                            <asp:TextBox ID="txtFees" CssClass="form-control pnl1text-input" onchange="RemoveValidate(this);" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-body">
                                        <div class="form-group">
                                            <label class="fntWeightBold">Days</label>
                                            <asp:TextBox ID="txtDays" CssClass="form-control pnl1text-input" onchange="RemoveValidate(this);" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-body">
                                        <div class="form-group">
                                            <label class="fntWeightBold">No Of Sessions</label>
                                            <asp:TextBox ID="txtSessions" CssClass="form-control pnl1text-input" onchange="RemoveValidate(this);" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <asp:UpdateProgress ID="UpdateProgress1" runat="server" AssociatedUpdatePanelID="updtPnlPTP">
        <ProgressTemplate>
