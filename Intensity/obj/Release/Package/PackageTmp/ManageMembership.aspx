                        ...
                        <div class="portlet-body">
                            ...
                            <div class="table-responsive">
                                <asp:GridView ID="grdMembership" runat="server" GridLines="None" CssClass="table table-bordered table-advance table-hover"
                                    ...
                                    AllowSorting="true" OnPageIndexChanging="grdMembership_PageIndexChanging" OnRowCommand="grdMembership_RowCommand" OnSorting="grdMembership_Sorting">
                                    <Columns>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox ID="txtOtherContact" runat="server" placeholder="OtherContact..." CssClass="form-control pnl1text-input" onchange="RemoveValidate(this);"></asp:TextBox>
                                            </div>
                                            <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div>
                                            <asp:CheckBoxList ID="chkbox1" runat="server" AutoPostBack="True">
                                                <asp:ListItem>SMS/MMS</asp:ListItem>
                                                <asp:ListItem>EMAIL</asp:ListItem>
                                                <asp:ListItem>MOBILE / TELEPHONE</asp:ListItem>
                                            </asp:CheckBoxList>
                                        </div>
                                    </div>
                                    <div class="form-body">
