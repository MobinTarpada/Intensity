...
namespace FitnessCenter
{
    public partial class frmManageLead : System.Web.UI.Page
    {
        ...
        protected void txtMmbrReg_TextChanged(object sender, EventArgs e)
        {
            ...
            txtMmbrname.Text = objLead.firstName;
        ...
        protected void grdLead_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (Edit != null && Transfer != null && Delete != null)
            {
                if (LoginUser.userTypeId != 2 && LoginUser.userTypeId != 8)
                {
                    Edit.Visible = false;
        ...
        private void BindLeadType()
        {
            try
            {
                ...
                ddlLeadTypeAdd.DataTextField = ddlLeadType.DataTextField = "leadType";
                ...
                ddlSearchLeadStatus.DataTextField = ddlLeadStatus.DataTextField = "status";
        ...
        private void InsertLead()
        {
            try
            {
                ...
                if (ddlLeadType.SelectedValue == "Referrals")
                {
        ...
        protected void grdLeadPresentation_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                if (e.CommandName == "EditPresentation")
                {
                    ...
                    chkppointmentAttended.Checked = objLeadPresentation.isAttendPresentation == null ? false : objLeadPresentation.isAttendPresentation.Value;
                    txtReasonForNotAttend.Text = objLeadPresentation.reasonsForNotAttend;
                }
