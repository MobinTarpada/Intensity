...
namespace FitnessCenter.BO
{
    ...
    public partial class Membership
    {
        ...
        public virtual long discountGivenBy
        {
            ...
            set
            {
                if (_discountGivenBy != value)
                {
                    if (User != null && User.ID != value)
                    {
                        User = null;
                    }
                    _discountGivenBy = value;
                }
            }
        }
        private long _discountGivenBy;
        [DataMember]
        ...
        [DataMember]
        public virtual string relationshipOfGuardian
        {
            get;
            set;
        }
        ...
        [DataMember]
        public virtual byte[] memberSiganture
        {
            get;
            set;
        }
        ...
        private void FixupUser(User previousValue)
        {
            ...
            if (User != null)
            {
                if (!User.Memberships.Contains(this))
                {
                    User.Memberships.Add(this);
                }
                if (discountGivenBy != User.ID)
                {
                    discountGivenBy = User.ID;
                }
            }
        }
        ...
        private void FixupUserSchemeMaster(UserSchemeMaster previousValue)
        {
            ...
            {
                if (!UserSchemeMaster.Memberships.Contains(this))
                {
                    UserSchemeMaster.Memberships.Add(this);
                }
