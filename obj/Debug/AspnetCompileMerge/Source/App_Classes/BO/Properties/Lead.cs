...
namespace FitnessCenter.BO
{
    ...
    public partial class Lead
    {
        ...
        private Nullable<long> _transferTo;
        [DataMember]
        ...
        private Nullable<long> _transferBy;
        [DataMember]
        ...
        {
            if (previousValue != null && previousValue.Leads1.Contains(this))
            {
            ...
            if (User1 != null)
            {
                if (!User1.Leads1.Contains(this))
                {
                    User1.Leads1.Add(this);
                }
                if (transferBy != User1.ID)
                {
                    transferBy = User1.ID;
                }
            }
        ...
        {
            if (previousValue != null && previousValue.Leads2.Contains(this))
            {
                previousValue.Leads2.Remove(this);
            }
    
            if (User2 != null)
            {
                if (!User2.Leads2.Contains(this))
                {
                    User2.Leads2.Add(this);
                }
                if (transferTo != User2.ID)
                {
                    transferTo = User2.ID;
                }
            }
