...
namespace FitnessCenter.BO
{
    ...
    public partial class Club
    {
        ...
        [DataMember]
        public virtual ICollection<ExerciseMaster> ExerciseMasters
        {
            get
            {
                if (_exerciseMasters == null)
                {
                    var newCollection = new FixupCollection<ExerciseMaster>();
                    newCollection.CollectionChanged += FixupExerciseMasters;
                    _exerciseMasters = newCollection;
                }
                return _exerciseMasters;
            }
            set
            {
                if (!ReferenceEquals(_exerciseMasters, value))
                {
                    var previousValue = _exerciseMasters as FixupCollection<ExerciseMaster>;
                    if (previousValue != null)
                    {
                        previousValue.CollectionChanged -= FixupExerciseMasters;
                    }
                    _exerciseMasters = value;
                    var newValue = value as FixupCollection<ExerciseMaster>;
                    if (newValue != null)
                    {
                        newValue.CollectionChanged += FixupExerciseMasters;
                    }
                }
            }
        }
        private ICollection<ExerciseMaster> _exerciseMasters;
        ...
        private void FixupExerciseMasters(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (e.NewItems != null)
            {
                foreach (ExerciseMaster item in e.NewItems)
                {
                    item.Club = this;
                }
            }
            ...
            if (e.OldItems != null)
            {
                foreach (ExerciseMaster item in e.OldItems)
                {
                    if (ReferenceEquals(item.Club, this))
                    {
                        item.Club = null;
