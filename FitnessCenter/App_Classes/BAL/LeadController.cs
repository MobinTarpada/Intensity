...
namespace FitnessCenter.BAL
{
    public class LeadController
    {
        ...
        public static List<LeadStatusMaster> GetLeadStatus()
        {
            try
            {
                return new FitnessCenterEntities().LeadStatusMasters.Where(x => x.isDeleted == false && x.ID != 7).ToList();
            }
            catch (Exception ex)
            {
        ...
        public static Lead GetLeadByMobile(string Mobile)
        {
            try
            {
                return new FitnessCenterEntities().Leads.FirstOrDefault(x => x.isDeleted == false && x.isActive == true && x.mobileNumber == Mobile);
            }
            catch (Exception ex)
            {
        ...
        public static Membership GetMebersByRegistraionNumber(string RegNo)
        {
            try
            {
                return new FitnessCenterEntities().Memberships.FirstOrDefault(x => x.isActive == true && x.MembershipNo == RegNo);
            }
            catch (Exception ex)
            {
        ...
        public static List<User> GetUserForTransfer(long ClubId, long UserId)
        {
            try
            {
                return new FitnessCenterEntities().Users.Where(x => x.isActive == true && x.isDeleted == false && x.ClubId == ClubId && x.ID != UserId && x.UserTypeId != 7).ToList();
            }
            catch (Exception ex)
            {
        ...
        #region DailyAppoinments

        public static List<GetLeadAppointmentByDates_Result> GetLeadAppointmentByDate(long ClubId, string SearchText, string AppoinmentDate, long UserId)
        {
            try
            {
                return new FitnessCenterEntities().GetLeadAppointmentByDates(ClubId, SearchText, AppoinmentDate, UserId).ToList();
            }
            catch (Exception ex)
            {
        ...
        #region DailyPresentations

        public static List<GetLeadPresentationByDates_Result> GetLeadPresentationByDate(long ClubId, string SearchText, string PresentaionDate)
        {
            try
            {
                return new FitnessCenterEntities().GetLeadPresentationByDates(ClubId, SearchText, PresentaionDate).ToList();
            }
            catch (Exception ex)
            {
        ...
        #region DailyFollowups

        public static List<GetLeadFollowupByDates_Result> GetLeadFollowupByDate(long ClubId, string SearchText, string FollowupDate, long UserId)
        {
            try
            {
                return new FitnessCenterEntities().GetLeadFollowupByDates(ClubId, SearchText, FollowupDate, UserId).ToList();
            }
            catch (Exception ex)
            {
        ...
        public static List<GetBirthDayByDates_Result> GetBirthDay(long ClubId, string SearchText, string Date, long UserId)
        {
            try
            {
                return new FitnessCenterEntities().GetBirthDayByDates(ClubId, SearchText, Date, UserId).ToList();
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public static List<GetAniversarryDayByDates_Result> GetAnniversary(long ClubId, string SearchText, string Date, long UserId)
        {
            try
            {
                return new FitnessCenterEntities().GetAniversarryDayByDates(ClubId, SearchText, Date, UserId).ToList();
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public static List<GetLeadHistoryByDates_Result> GetLeadHistoryByDate(string SearchText, string FollowupDate)
        {
            try
            {
                return new FitnessCenterEntities().GetLeadHistoryByDates(SearchText, FollowupDate).ToList();
            }
            catch (Exception ex)
            {
                throw ex;
