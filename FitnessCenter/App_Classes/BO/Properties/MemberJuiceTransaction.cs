...
namespace FitnessCenter.BO
{
    ...
    public partial class MemberJuiceTransaction
    {
        ...
        {
            if (previousValue != null && previousValue.MemberJuiceTransactions.Contains(this))
            {
                previousValue.MemberJuiceTransactions.Remove(this);
            }
    
            if (ItemMaster != null)
            {
                if (!ItemMaster.MemberJuiceTransactions.Contains(this))
                {
                    ItemMaster.MemberJuiceTransactions.Add(this);
                }
        ...
        private void FixupMembership(Membership previousValue)
        {
            ...
            if (Membership != null)
            {
                if (!Membership.MemberJuiceTransactions.Contains(this))
                {
                    Membership.MemberJuiceTransactions.Add(this);
                }
