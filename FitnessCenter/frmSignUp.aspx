<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmSignUp.aspx.cs" Inherits="FitnessCenter.frmSignUp" %>
...
<head runat="server">
    <meta charset="utf-8" />
    <title>Fitness Management | Register </title>
            ...
            <asp:Panel ID="pnlLogin" runat="server" DefaultButton="lnkBtnLogin">
                <div class="form-group">
                    ...
                    <div class="input-icon">
                        ...
                        <asp:TextBox ID="txtFirstName" runat="server" placeholder="FirstName..." CssClass="form-control placeholder-no-fix pnl1text-input" onchange="RemoveValidate(this);" AutoCompleteType="None"></asp:TextBox>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-icon">
                        ...
                        <asp:TextBox ID="txtLastName" runat="server" CssClass="form-control placeholder-no-fix pnl1text-input" onchange="RemoveValidate(this);" placeholder="LastName"></asp:TextBox>
                    </div>
                </div>
