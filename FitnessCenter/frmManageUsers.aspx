                                ...
                                <asp:GridView ID="grdUsers" runat="server" GridLines="None" CssClass="table table-bordered table-advance table-hover"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="USER TYPE">
                                            <ItemTemplate>
                                                <span><%# Eval("UserTypeMaster.TypeName") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                ...
                                <div class="col-md-6">
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtMobileNumber" runat="server" placeholder="Mobile Number..." CssClass="form-control pnl1text-input pnl1text-mobile" onchange="RemoveValidate(this);"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
