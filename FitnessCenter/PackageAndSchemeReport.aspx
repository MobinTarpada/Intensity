<%@ Page Title="" Language="C#" MasterPageFile="~/MstFitnessCenter.Master" AutoEventWireup="true" CodeBehind="PackageAndSchemeReport.aspx.cs" Inherits="FitnessCenter.PackageAndSchemeReport" %>
    ...
    <asp:UpdatePanel ID="updtPnlPckgnScm" runat="server">
        <ContentTemplate>
            <div class="page-content">
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="page-title">Manage Package And Scheme Report</h3>
                                    ...
                                    <div class="col-md-2" style="padding: 0px;">
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox ID="txtFromDate" PlaceHolder="FromDate..." runat="server" CssClass="form-control datePicker"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-2" style="padding: 0px;">
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox ID="txtToDate" PlaceHolder="ToDate..." runat="server" CssClass="form-control datePicker"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-2" style="padding: 0px;">
                                ...
                                <div class="table-responsive">
                                    <asp:GridView ID="grdPkgNScmReport" runat="server" GridLines="None" CssClass="table table-bordered table-advance table-hover"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="PackageAmount">
                                                <ItemTemplate>
                                                    <span><%# Eval("packageAmount") %></span>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="SchemeAmount">
                                                <ItemTemplate>
                                                    <span><%# Eval("schemeAmount") %></span>
                                                </ItemTemplate>
                                            </asp:TemplateField>
