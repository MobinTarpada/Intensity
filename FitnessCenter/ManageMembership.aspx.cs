...
namespace FitnessCenter
{
    public partial class ManageMemberShip : System.Web.UI.Page
    {
        ...
        public Lead TransferLead
        {
            get
            {
                var obj = Session["objLead"];
                return obj == null ? null : (Lead)obj;
            }
        }
        public Membership TransferTo
        {
            get
            {
                var obj = Session["objNewMember"];
                return obj == null ? null : (Membership)obj;
            }
        }

        public Membership TransferFrom
        {
            get
            {
                var obj = Session["objmember"];
                return obj == null ? null : (Membership)obj;
            }
        }
        ...
        public string Email
        {
            get
            {
                var obj = ViewState["Email"];
                return obj == null ? "Email" : (string)obj;
            }
            set
            {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    if (Request.QueryString["pnlEdit"] == "pnlEdit")
                    {
                        BindPackageType();
                        BindSchemesType(0);
            ...
            try
            {
                ...
                if (Mode == "Insert")
                {
                    ...
                    foreach (ListItem item in chkbox1.Items)
                    {
                        if (item.Value == "1")
                            SendSmS();
                        if (item.Value == "2" && CheckForInternetConnection())
                            ValidateEmail();
                        else
        ...
        protected void ddlSchemeType_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                if (ddlSchemeType.SelectedIndex != 0)
                {
                    ...
                    txtSchMem.Text = txtActMem.Text = Convert.ToString(objScheme.MemberFee);
                    txtSchAdmin.Text = txtActAdmin.Text = Convert.ToString(objScheme.AdminFee);
                    txtSchPTP.Text = txtActPTP.Text = Convert.ToString(objScheme.PTFee);
        ...
        public void SendSmS()
        {
            try
            {
                if (MobileNumber != "" && Message != "" && MobileNumber != "MobileNumber")
                {
                    string msg = Message;
                    string Actype = "1";
                    string Msgtype = "0";
        ...
        private void BindMembersValues()
        {
            try
            {
                ...
                //    txtAgreementNumber.Text = objMember.AgreementNo;
                //    //txtBranchName.Text = objMember.branchName;
                //    txtConsultant.Text = objMember.Consultant;
                //    ddlPkgtype.SelectedValue = Convert.ToString(objMember.PackageId);
                ...
                //    pnlActPayment.Visible = true;
                //    SchemeMaster objScheme = SchemeMasterController.GetSchemeMasterByID(Convert.ToInt64(ddlSchemeType.SelectedValue));
                //    txtSchJoin.Text = Convert.ToString(objScheme.JoiningFee);
                //    txtSchAdmin.Text = Convert.ToString(objScheme.AdminFee);
                //    txtSchMem.Text = Convert.ToString(objScheme.MemberFee);
                //    txtSchPTP.Text = Convert.ToString(objScheme.PTFee);
                ...
                //    txtActMem.Text = Convert.ToString(objMember.MemberFee);
                //    txtActPTP.Text = Convert.ToString(objMember.PTFee);
        ...
        private void InsertMember()
        {
            try
            {
                ...
                //    objMember.PackageId = Convert.ToInt32(ddlPkgtype.SelectedValue);
                ...
                //    objMember.MemberFee = Convert.ToDecimal((txtActMem.Text == "") ? objScheme.membershipFee : Convert.ToDecimal(txtActMem.Text));
                //    objMember.PTFee = Convert.ToDecimal((txtActPTP.Text == "") ? objScheme.personalTrainingPack : Convert.ToDecimal(txtActPTP.Text));
                ...
                //    objMember.AgreementNo = txtAgreementNumber.Text;
                //    objMember.Consultant = txtConsultant.Text;
                ...
                //    objMember.GuardianRelation = txtRelationshipOfGuardian.Text;
                ...
                //    objMember.EmergencyContactNo = txtEmergencyContact.Text;
                //    objMember.isPaid = paid;
                //    objMember.MembershipNo = (paid) ? txtMembrNmbr.Text : null;
                //    objMember.RFIDCardNumber = paid ? txtRFIDNo.Text : null;

                //    objMember = new MembershipController().InsertMember(objMember);

                //    // CreateMemberUser(objMember.leadId, objMember.agreementNumber);
                ...
                //    Message = "HELLO DEAR MEMBER YOU ARE SUCCESSFULLY JOIN WITH INTENSITY BEYOND FITNESS \nYOUR AGREEMENT NUMBER IS : " + txtAgreementNumber.Text + "\nYOUR REGISTRATION DATE IS : " + txtJDate.Text + "\nYOUR ACTIVATION DATE IS : " + txtADate.Text + "\nYOUR EXPIRY DATE IS : " + txtEDate.Text;
        ...
        private void UpdateMember()
        {
            ...
            objMember.PackageId = Convert.ToInt32(ddlPkgtype.SelectedValue);
            objMember.SchemeId = Convert.ToInt32(ddlSchemeType.SelectedValue);
            objMember.PackageAmount = Convert.ToDecimal(txtSchTotAmt.Text);
            objMember.JoiningFee = Convert.ToDecimal(txtActJoin.Text);
            objMember.AdminFee = Convert.ToDecimal(txtActAdmin.Text);
            objMember.MemberFee = Convert.ToDecimal(txtActMem.Text);
            objMember.PTFee = Convert.ToDecimal(txtActPTP.Text);
            objMember.DiscountGivenBy = LoginUser.UserTypeId;
            objMember.FinalAmount = Convert.ToDecimal(txtAmtPyb.Text);
            objMember.ActivationDate = UtillController.ConvertDateTime(txtADate.Text);
            objMember.RegistrationDate = UtillController.ConvertDateTime(txtJDate.Text);
        ...
        //{
        //    //SchemeMaster objUsrScm = MembershipController.GetDiscountByUserTypeId(LoginUser.UserTypeId);
        ...
        public void InsertTransferMember()
        {
            try
            {
                if (!MembershipController.IsMemberExists(txtAgreementNumber.Text.Trim()))
                {
                    ...
                    objMember.JoiningFee = Convert.ToDecimal((txtActJoin.Text == "") ? objScheme.JoiningFee : Convert.ToDecimal(txtActJoin.Text));
                    objMember.AdminFee = Convert.ToDecimal((txtActAdmin.Text == "") ? objScheme.AdminFee : Convert.ToDecimal(txtActAdmin.Text));
                    objMember.MemberFee = Convert.ToDecimal((txtActMem.Text == "") ? objScheme.MemberFee : Convert.ToDecimal(txtActMem.Text));
                    objMember.PTFee = Convert.ToDecimal((txtActPTP.Text == "") ? objScheme.PTFee : Convert.ToDecimal(txtActPTP.Text));
                    //objMember.serviceTaxInPercentage = Convert.ToDecimal((txtActSerTax.Text == "") ? objScheme.serviceTaxInPercentage : Convert.ToDecimal(txtActSerTax.Text));
                    objMember.DiscountGivenBy = LoginUser.UserTypeId;
                    objMember.FinalAmount = Convert.ToDecimal(txtAmtPyb.Text);
                    objMember.ActivationDate = UtillController.ConvertDateTime(txtADate.Text);
                    ...
                    if (txtEmail.Text == "")
                        ...
                        Email = txtEmail.Text;
                    MobileNumber = txtMobileNumber.Text;
                    long a = TransferFrom.LeadId;

                    Lead objLead = LeadController.GetLeadById(a);
        ...
        private void UpdateTransferMember()
        {
            Membership objMember = MembershipController.GetMembersByLeadId(Convert.ToString(TransferFrom.LeadId));
            objMember.TransferBy = TransferFrom.ID;
            objMember.TransferTo = TransferTo.ID;
        ...
        private void UpdateTransferLead()
        {
            try
            {
                Lead objLead = LeadController.GetLeadById(TransferTo.LeadId);
                objLead.firstName = txtFName.Text;
                objLead.lastName = txtLName.Text;
                objLead.gender = rdoGender.SelectedValue;
                objLead.dateOfBirth = UtillController.ConvertDateTime(txtDOB.Text);
        ...
        public void BindTransferMemberToAnother()
        {
            try
            {
                Mode = "Transfer";
                ddlTitle.SelectedValue = TransferFrom.Title;
                txtMembrNmbr.Text = "";
                txtAgreementNumber.Text = TransferFrom.AgreementNo;
                //txtBranchName.Text = TransferFrom.branchName;
                //txtConsultant.Text = TransferFrom.Consultant;
                rdoGender.SelectedValue = TransferLead.gender;
                if (TransferLead.dateOfBirth == null)
                {
                    txtDOB.Text = "";
                }
                else
                {
                    txtDOB.Text = Convert.ToString(TransferLead.dateOfBirth).Substring(0, 10);
                }

                txtFName.Text = TransferLead.firstName;
                txtLName.Text = TransferLead.lastName;
                txtAddress.Text = TransferLead.address;
                txtCity.Text = TransferLead.city;
                txtPincode.Text = TransferLead.pincode;
                txtMobileNumber.Text = TransferLead.mobileNumber;
                txtOtherContact.Text = TransferLead.otherContactNumber;
                txtEmail.Text = TransferLead.Email;

                ddlPkgtype.SelectedValue = Convert.ToString(TransferFrom.PackageId);
                BindSchemesType(Convert.ToInt64(ddlPkgtype.SelectedValue));
                #region Packages
                PackageMaster objPckg = PackageMasterController.GetPackageById(Convert.ToInt64(TransferFrom.PackageId));                

                #endregion  `
                #region Schemes
                ddlSchemeType.SelectedValue = Convert.ToString(TransferFrom.SchemeId);
                if (LoginUser.UserTypeId == 2 || LoginUser.UserTypeId == 8)
                    ddlSchemeType.Enabled = true;
                else
                    ddlSchemeType.Enabled = false;
                pnlActPayment.Visible = true;
                SchemeMaster objScheme = UserSchemeMasterController.GetUserSchemeMasterByID(Convert.ToInt64(ddlSchemeType.SelectedValue));
                txtSchJoin.Text = Convert.ToString(objScheme.JoiningFee);
                txtSchAdmin.Text = Convert.ToString(objScheme.AdminFee);
                txtSchMem.Text = Convert.ToString(objScheme.MemberFee);
                txtSchPTP.Text = Convert.ToString(objScheme.PTFee);
                ...
                #region Actual
                lblSchName.Text = ddlSchemeType.SelectedItem.Text;
                txtActJoin.Text = Convert.ToString(TransferFrom.JoiningFee);
                txtActAdmin.Text = Convert.ToString(TransferFrom.AdminFee);
                txtActMem.Text = Convert.ToString(TransferFrom.MemberFee);
                txtActPTP.Text = Convert.ToString(TransferFrom.PTFee);
                //txtActSerTax.Text = Convert.ToString(TransferFrom.serviceTaxInPercentage);
                txtActTotAmt.Text = txtAmtPyb.Text = Convert.ToString(TransferFrom.FinalAmount);
                foreach (Control ctrl in pnlActPayment.Controls)
                {
                    if (LoginUser.UserTypeId == 2 || LoginUser.UserTypeId == 8)
                    {
                ...
                DateTime jdate, adate, edate;
                jdate = (DateTime)TransferFrom.RegistrationDate;
                adate = (DateTime)TransferFrom.ActivationDate;
                edate = (DateTime)TransferFrom.ExpiryDate;
                txtJDate.Text = jdate.ToString("dd/MM/yyyy");
                txtADate.Text = adate.ToString("dd/MM/yyyy");
                txtEDate.Text = edate.ToString("dd/MM/yyyy");
                if (LoginUser.UserTypeId == 2 || LoginUser.UserTypeId == 8)
                    ...
                    txtJDate.ReadOnly = txtADate.ReadOnly = true;
                string[] sendItems = TransferFrom.SendMaterialsBy.Split(',');
                for (int i = 0; i < sendItems.Length; i++)
                {
                    foreach (ListItem item in chkbox1.Items)
                    {
                ...
                //if ((bool)TransferFrom.isPaid)
                //{
                //    rdoPayBy.SelectedValue = Convert.ToString(TransferFrom.payMode);
                //    rdoPayBy.Enabled = false;
                //    //NextButton.Visible = Backbutton.Visible = false;
                //    // btnPayment.Visible = false;
                ...
                //    {
                //        PanelPaymentVisibility(true, true, false);
                //        //txtAmountPaid.Text = Convert.ToString(TransferFrom.amountPaid);
                //        //txtAmountPaid.ReadOnly = (bool)TransferFrom.isPaid;
                //        //txtRemainingAmount.Text = Convert.ToString(TransferFrom.remainingAmount);
                //        //txtBillAmount.Text = Convert.ToString(TransferFrom.FinalAmount);
                //        btnSubmit.Visible = false;
                //        chkIsPaid.Checked = true;
                //        chkIsPaid.Enabled = false;
                //    }
                ...
                //    {
                //        PanelPaymentVisibility(true, false, true);
                //        //txtBranchDetails.Text = TransferFrom.Branch;
                //        //txtBankName.Text = TransferFrom.BankName;
                //        //txtChkNo.Text = TransferFrom.chequeNumber;
                //        ////txtAmount.Text = Convert.ToString(objMember.amountPaid);
                //        //DateTime chqdt = (DateTime)TransferFrom.chequeDate;
                //        //txtChkDate.Text = chqdt.ToString("dd/MM/yyyy");
                //        //txtAmount.Text = Convert.ToString(TransferFrom.FinalAmount);
                //        chkChqPaid.Checked = txtAmount.ReadOnly = true;
                //        chkChqPaid.Enabled = false;
                //        //btnChqSubmit.Visible = false;
                //    }
                //    txtRFIDNo.Text = TransferFrom.RFIDCardNumber;
                //}
                //else
                //{
                //    rdoPayBy.Enabled = true;
                ...
                //    chkIsPaid.Enabled = chkChqPaid.Enabled = true;
                //}
                txtGuardianName.Text = TransferFrom.GuardianName;
                txtRelationshipOfGuardian.Text = TransferFrom.GuardianRelation;
                txtCorporateId.Text = TransferFrom.CorporateId;
                txtCompanyName.Text = TransferFrom.CorporateName;
                txtEmergencyContact.Text = TransferFrom.EmergencyContactNo;
                txtEmrgncyCntcNm.Text = TransferFrom.EmergencyContactName;
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        protected void btnTransferLeads_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    objNewmember.PackageId = objmember.PackageId;
                    ...
                    //objNewmember.MemberFee = objmember.MemberFee;
                    //objNewmember.PTFee = objmember.PTFee;
                    ...
                    //objNewmember.membershipUniqueId = objmember.membershipUniqueId;
