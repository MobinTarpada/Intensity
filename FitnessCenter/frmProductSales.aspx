                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-body">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtQty" runat="server" CssClass="form-control pnl1text-input" onchange="RemoveValidate(this);" placeholder="Item Quantity.." AutoPostBack="True" OnTextChanged="txtQty_TextChanged" ></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-body">
                                        <div class="form-group">
