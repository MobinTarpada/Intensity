                                    ...
                                    <div class="col-md-6">
                                        <div class="form-body">
                                            ...
                                            <div c-lass="form-group">
                                                ...
                                                <asp:TextBox ID="txtService" runat="server" placeholder="Service Tax.." CssClass="form-control pnl1text-input" onchange="RemoveValidate(this);"></asp:TextBox>
                                                <asp:Label runat="server" ID="taxAmt"></asp:Label>
                                                <asp:Label runat="server" ID="taxAmt1"></asp:Label>

                                            </div>
                                            <div class="form-group">
                                                <label class="fntWeightBold">Total Amount</label>
                                                <asp:TextBox ID="txtTotAmt" runat="server" placeholder="Total Amount.." CssClass="form-control pnl1text-input" AutoPostBack="true" OnTextChanged="txtTotAmt_TextChanged" onchange="RemoveValidate(this);"></asp:TextBox>
                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-body">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label class="fntWeightBold">Total Amount</label>
                                                                        <asp:TextBox ID="txtTAmt" runat="server" CssClass="form-control pnl1text-input" onchange="RemoveValidate(this);"></asp:TextBox>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="clearfix"></div>
