<%@ Page Title="" Language="C#" MasterPageFile="~/MstFitnessCenter.Master" AutoEventWireup="true" CodeBehind="frmFacilities.aspx.cs" Inherits="FitnessCenter.frmFacilities" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <asp:UpdatePanel ID="updtPnlFacility" runat="server">
        <ContentTemplate>
                    ...
                    <div class="portlet box blue">
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="table-responsive">
                                <asp:GridView ID="grdFacillity" runat="server" GridLines="None" CssClass="table table-bordered table-advance table-hover"
                                    EmptyDataText="No Record Found..!" AutoGenerateColumns="False"
                                    AllowPaging="True" PagerStyle-CssClass="CustomPagination"
                                    AllowSorting="True" OnPageIndexChanging="grdFacillity_PageIndexChanging" OnRowCommand="grdFacillity_RowCommand">
                                    <Columns>
                                        <asp:TemplateField HeaderText="Name">
                                            <ItemTemplate>
                                                <span><%#Eval("facilityName") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Image">
                                            <ItemTemplate>
                                                <asp:Image ID="imgSer" runat="server" ImageUrl='<%#Eval("image") %>' Height="100" Width="100" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
    ...
    <asp:UpdateProgress ID="UpdateProgress1" runat="server" AssociatedUpdatePanelID="updtPnlFacility">
        <ProgressTemplate>
